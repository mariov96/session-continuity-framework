# Wheelwright Framework - Strategic Buildstate
...
**Wheelwright Framework v2.2.0**
**Structure:** v2 (.WAI/ directory)
...
- AI instruction generation (WAI-Guide.md)
...
### Next Up
- `WAI hub create` command for guided hub setup
